...
if(!['801545390150254612'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
return message.reply(`Bu Komut İçin Yetkiniz Bulunmamaktadır.`) 
  
const erkekrol = message.guild.roles.cache.find(r => r.id === '801544718055374870') //erkekrol ismini değişmeyin
const kayıtsız = message.guild.roles.cache.find(r => r.id === '801544802239774740')
